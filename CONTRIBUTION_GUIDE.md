...
We welcome contributions to our [open source project on GitHub](https://github.com/superfaceai/service-client).
...
If you have any question about this project (for example, how to use it) or if you just need some clarification about anything, please open an Issue at [Issues](https://github.com/superfaceai/service-client/issues).
...
2. **Setup** the Superface service-client
...
If you are experiencing bug or undocumented behavior please open an Issue with bug template at [Issues](https://github.com/superfaceai/service-client/issues).
...
The Superface service-client open source project is licensed under the [MIT License](LICENSE).
